...
void drawWindow(NVGcontext* vg, const char* title, float x, float y, float w, float h)
{
    ...
    // Header
    headerPaint = nvgLinearGradient(vg, x, y, x, y + 15, nvgRGBA(255, 255, 255, 0), nvgRGBA(0, 0, 0, 0));
    nvgBeginPath(vg);
    ...
    nvgStrokeColor(vg, nvgRGBA(255, 0, 0, 32));
    nvgStroke(vg);
...
{
    int font;
    font = nvgCreateFont(vg, "sans", "data/Roboto-Regular.ttf");
    if (font == -1) {
